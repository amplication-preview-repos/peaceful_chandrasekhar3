...
export class ReviewResolverBase {
  ...
  async createReview(@graphql.Args() args: CreateReviewArgs): Promise<Review> {
    return await this.service.createReview({
      ...
      data: {
        ...
        aiTool: args.data.aiTool
          ? {
              connect: args.data.aiTool,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => AiTool, {
    nullable: true,
    name: "aiTool",
  })
  async getAiTool(@graphql.Parent() parent: Review): Promise<AiTool | null> {
    const result = await this.service.getAiTool(parent.id);
